...
import br.com.geconp.geconp.async.AsyncAddLanRec;
import br.com.geconp.geconp.dao.DatabaseManager;
import br.com.geconp.geconp.model.MovimentoReceita;


public class AdicionarLanReceActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adicionar_lan_rece);

        spCat= (Spinner)findViewById(R.id.spinnerTipoExtRec);
        spCon= (Spinner) findViewById(R.id.spinnerContaExtRec);
        ...
        Button add= (Button) findViewById(R.id.buttonAddLanReceita);
    ...
    protected void onResume() {
        super.onResume();
        txtData = (EditText) findViewById(R.id.editTextLanDat);
    ...
    public void gravar(final String itemTipo, final String itemConta){
        txtValor = (EditText) findViewById(R.id.editTextLanVal);
        txtDescricao = (EditText) findViewById(R.id.editTextLanDesc);
        ...
        if (txtValor.getText().toString().equals(".00") || txtValor.getText().toString().equals("") || txtData.getText().toString().equals("") ||
            ...
            MovimentoReceita movimento= new MovimentoReceita(valor, d, descricao, itemTipo, itemConta);
            AsyncAddLanRec asyn= new AsyncAddLanRec(movimento, this);
            asyn.execute();
            limparCampos();
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_adicionar_lan_rece, menu);
        return true;
    }
