...
import br.com.geconp.geconp.async.AsyncAtMovDes;
...
public class AttMovDespesaActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_att_mov_despesa);

        spCat= (Spinner)findViewById(R.id.spinnerAttTipoMoDes);
        spCon= (Spinner) findViewById(R.id.spinnerAttConMoDes);
        ...
        txtData = (EditText) findViewById(R.id.editTextAttDatMovDes);
        txtValor= (EditText)findViewById(R.id.editTextAttValMovDes);
        txtDescricao= (EditText)findViewById(R.id.editTextAttDesMoDes);
        ...
        Button add= (Button)findViewById(R.id.buttonAttMovDes);
    ...
    private void gravar(String idRec, final String itemTipo, final String itemConta) {
        if (txtValor.getText().toString().equals(".00") || txtValor.getText().toString().equals("") ||
            ...
            MovimentoDespesa movimento= new MovimentoDespesa(id, valor, d, descricao, itemTipo, itemConta);
            //new AsyncAtu(movimento).execute();
            DatabaseManager manager= new DatabaseManager(AttMovDespesaActivity.this);
            manager.atualizarMovDespesa(movimento);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_att_mov_despesa, menu);
        return true;
    }
    ...
    private class AsyncAtu extends AsyncTask<Void, Void, Void>{
        ...
        private AsyncAtu(MovimentoDespesa movimento) {
        ...
        protected Void doInBackground(Void... params) {
            DatabaseManager manager= new DatabaseManager(AttMovDespesaActivity.this);
            manager.atualizarMovDespesa(this.movimento);
            return null;
        }
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            carregando= new ProgressDialog(AttMovDespesaActivity.this);
