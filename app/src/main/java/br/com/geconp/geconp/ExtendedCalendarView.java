...
import br.com.geconp.geconp.calendar.CalendarAdapter;
import br.com.geconp.geconp.calendar.Day;
...
public class ExtendedCalendarView extends RelativeLayout implements OnItemClickListener,
    ...
    private void init(){
		...
		prev.setImageResource(R.mipmap.navigation_previous_item);
		...
		next.setImageResource(R.mipmap.navigation_next_item);
